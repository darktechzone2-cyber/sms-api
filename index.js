...
// Manual CORS headers (no need for 'cors' package)
...
// Country mapping (short version – add more as needed)
const COUNTRY_MAP = {
...
app.get('/', (req, res) => {
    res.send(`
        ...
        <body style="background:#0a0c10;color:#fff;font-family:monospace;padding:2rem;">
            ...
            <p>✅ Running (CORS enabled manually)</p>
...
// Initial login – if it fails, exit
login().catch(err => {
